class WebSearchTool < Formula
  ...
  resource "firecrawl-py" do
    url "https://files.pythonhosted.org/packages/2d/09/e7c667875c9a9dac09480e2f69fd46bdd9c1139555b835c3036a9858aff2/firecrawl_py-4.28.2.tar.gz"
    sha256 "7e6181e2129b63c8d6aec5728d9b2fcf16ea82cb854372ad824b278efd258696"
  end
  ...
  resource "serpapi" do
    url "https://files.pythonhosted.org/packages/8d/19/6af9f42d372d2d0012493155f5decf0a889f434e824a6b281ab2c8f88822/serpapi-1.0.2.tar.gz"
  ...
  resource "tavily-python" do
    url "https://files.pythonhosted.org/packages/c3/17/c9eb61fdb8787008321724256a7b4d8537c2bd7e5dea3a9d906f344b873a/tavily_python-0.7.25.tar.gz"
    sha256 "7fa4a4e9248db8766af1273d0604e48dbf8ff4359af683238feaba8974b259ea"
  end
  ...
  test do
    system bin/"web-search-tool", "--help"
  end
end
